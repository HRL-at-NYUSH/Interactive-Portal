          ...
          <DropNav>
            <Item icon={<FaPlus />}>
              <div className='dropdown'>
                <div>
                  <a href='#' className='menu-item' onClick={this.handleDist}>
                    Distribution
                  </a>
                </div>
                <div>
                  <a href='#' className='menu-item' onClick={this.handleCorr}>
                    Correlation
                  </a>
                </div>
                <div>
                  <a href='#' className='menu-item' onClick={this.handleTime}>
                    Time
                  </a>
                </div>
                <div>
                  <a href='#' className='menu-item' onClick={this.handleSpace}>
                    Space
                  </a>
                </div>
                <div>
                  <a href='#' className='menu-item' onClick={this.handlePlay}>
                    Playground
                  </a>
                </div>
              </div>
